        ...
        detailContent.innerHTML = `
            <div class="client-detail-info">
                ...
                <div class="detail-item full-width">
                    ...
                    <div class="detail-value">
                        <a href="client.html?id=${client.id}" target="_blank" style="color: #667eea; text-decoration: underline;">
                            ${window.location.origin}${window.location.pathname.replace('index.html', '')}client.html?id=${client.id}
                        </a>
                    </div>
                </div>
                ${client.notes ? `
